...
plt.semilogy(sigma,SNN_MMSE_BER_5E_2000B_BS200000_1US_TfI_ADAM_MAX_NVA_NS, label='Arnold et.al SNN 5 Epochs 2000 Batch Batchsize 200000 1 Updatestep LR 1e-3 Train from Init ADAM MAX Decoding No varring alpha No scheduler',marker=5);
plt.semilogy(sigma,SNN_MMSE_BER_5E_2000B_BS200000_1US_TfI_ADAM_MAX_NVA_NS_14dB, label='Arnold et.al SNN 5 Epochs 2000 Batch Batchsize 200000 1 Updatestep LR 1e-3 Train from Init ADAM MAX Decoding No varring alpha No scheduler 14dB Operationpoint',marker=5);
